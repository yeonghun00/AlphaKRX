...
class SectorFeatures(FeatureGroup):
    name = "sector"
    # sector_breadth_21d and sector_constituent_share removed: both depend on
    # constituent_index_count which is back-filled from current index membership —
    # confirmed lookahead bias (same root cause as constituent_index_count itself).
    columns = [
        "sector_momentum_21d",
        "sector_momentum_63d",
    ...
    dependencies = ["ret_1d", "mom_21d", "mom_63d"]
