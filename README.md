...
|--|--|--|
| **Total Return** | **+545.9%** | +218.4% |
| **Ann. Return** | **+23.0%** | +13.5% |
| **Sharpe Ratio** | **1.17** | — |
| **Max Drawdown** | -29.4% | — |
| **Alpha** | **+327.5%** | — |
| **Beta** | 0.29 | 1.0 |
...
*Statistical significance: Sharpe t-stat 3.52 (p=0.001), Newey-West HAC, Bootstrap CI [0.55, 2.16]*

![Backtest Report](runs/test_run/report.png)
